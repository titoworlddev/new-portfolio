    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-slate-700/50 flex-shrink-0">
          <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-teal-400 pr-4 leading-tight">
            {project.title}
          </h2>
          <Button
            variant="ghost"
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              {project.links.map((link: any, index: number) => (
                <a
                  ...
                  style={{
                    background:
                      'linear-gradient(to right, rgb(20, 184, 166), rgb(16, 185, 129))',
                    color: 'white',
                    border: 'none',
                  ...
                  onMouseEnter={e => {
                    e.currentTarget.style.background =
                      'linear-gradient(to right, rgb(13, 148, 136), rgb(5, 150, 105))';
                  }}
                  onMouseLeave={e => {
                    e.currentTarget.style.background =
                      'linear-gradient(to right, rgb(20, 184, 166), rgb(16, 185, 129))';
                ...
                >
                  ...
                  {link?.includes('github') ? 'Ver Código' : 'Ver Proyecto'}
                </a>
              ))}
            </div>
          </div>
